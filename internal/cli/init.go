...
func runImport(cmd *cobra.Command, reg *adapter.Registry, root, home string, picked []string) error {
	...
	_, _ = fmt.Fprintf(cmd.OutOrStdout(),
		...
		picked, root, len(bundle.Skills), len(bundle.Agents), len(bundle.Rules), len(bundle.MCP.Servers), len(instructions),
	)
	return nil
}
...
func writeCanonical(root string, b *canonical.Bundle, picked []string) error {
	for _, sub := range []string{"profiles", "skills", "agents", "rules", "instructions"} {
